...
data = pd.read_csv(os.path.join(thisDir,'raw',fn),encoding='utf-16')
...
data.to_csv(os.path.join(thisDir,'gradientTest-1','data.csv'),index=False)

fn = '20161010PQ_osmo_key.xlsx'
meta = pd.read_excel(os.path.join(thisDir,'raw',fn))
meta.to_csv(os.path.join(thisDir,'gradientTest-1','meta.csv'),index=False)
